...
public class DoctorController {
	...
	@GetMapping("/dctor/specialization/{spl}")
	public ResponseEntity<List<Doctor>> fetchDoctorDetailsByspl(@PathVariable("spl") String spl) {
		List<Doctor> doctor = idoctorService.getbySpecialization(spl);
